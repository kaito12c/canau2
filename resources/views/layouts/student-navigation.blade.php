<nav x-data="{ open: false }" class="bg-white border border-blue-100">
                    ...
                    <x-dropdown align="right" width="60">
                        <x-slot name="trigger">
                            ...
                            {{-- @admin --}}
                                ...
                                <x-slot name="event">
                                    <div>
                                        <x-dropdown-link :href="route('student.event')"
                                            :active="request()->routeIs('student.event')">
                                            {{ __('進路相談をセッティングする') }}
                                        </x-dropdown-link>                            
                                    </div>
                                </x-slot>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('student.sessions')" :active="request()->routeIs('student.sessions')">
                {{ __('student.sessions') }}
