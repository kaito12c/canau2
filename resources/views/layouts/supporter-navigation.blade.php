<nav x-data="{ open: false }" class="bg-white border border-blue-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                {{-- <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('supporter.sessions') }}">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="right" width="60">
                            ...
                            <div>({{ Auth::user()->email }})</div>
                                ...
                                <x-slot name="profile">
                                        <div>
                                            ...
                                            <x-dropdown-link :href="route('supporter.profile.edit', auth()->user()->id)"
                                                :active="request()->routeIs('supporter.profile.edit', auth()->user()->id)">
                                                {{ __('マイページ') }}
                                            </x-dropdown-link>     
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('supporter.logout')"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('supporter.sessions')" :active="request()->routeIs('supporter.sessions')">
                {{ __('supporter.sessions') }}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('supporter.logout') }}">
                    @csrf
                    <x-responsive-nav-link :href="route('supporter.logout')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
